...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1570 so far, 978 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1570 calls on the record as of 2026-08-20.
