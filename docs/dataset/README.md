...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1450 so far, 853 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1450 calls on the record as of 2026-08-15.
