...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1114 so far, 524 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1114 calls on the record as of 2026-08-01.
