...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1690 so far, 1101 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1690 calls on the record as of 2026-08-25.
