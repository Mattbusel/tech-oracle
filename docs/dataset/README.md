...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1210 so far, 609 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1210 calls on the record as of 2026-08-05.
