...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (2146 so far, 1535 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 2146 calls on the record as of 2026-09-13.
