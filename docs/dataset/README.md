...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1498 so far, 898 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1498 calls on the record as of 2026-08-17.
