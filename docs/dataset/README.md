...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (2098 so far, 1492 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 2098 calls on the record as of 2026-09-11.
