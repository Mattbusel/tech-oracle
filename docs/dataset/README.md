...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1762 so far, 1171 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1762 calls on the record as of 2026-08-28.
