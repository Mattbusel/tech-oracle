...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (202 so far, 25 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 202 calls on the record as of 2026-06-24.
