...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1714 so far, 1123 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1714 calls on the record as of 2026-08-26.
