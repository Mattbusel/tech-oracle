...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1378 so far, 787 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1378 calls on the record as of 2026-08-12.
