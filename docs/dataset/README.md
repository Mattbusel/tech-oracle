...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1330 so far, 737 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1330 calls on the record as of 2026-08-10.
