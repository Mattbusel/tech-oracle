...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1546 so far, 950 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1546 calls on the record as of 2026-08-19.
