...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (2266 so far, 1685 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 2266 calls on the record as of 2026-09-18.
