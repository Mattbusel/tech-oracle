...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (490 so far, 93 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 490 calls on the record as of 2026-07-06.
