...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1594 so far, 1004 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1594 calls on the record as of 2026-08-21.
