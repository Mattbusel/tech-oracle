...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (802 so far, 214 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 802 calls on the record as of 2026-07-19.
