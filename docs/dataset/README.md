...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1354 so far, 750 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1354 calls on the record as of 2026-08-11.
