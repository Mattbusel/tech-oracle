...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1234 so far, 637 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1234 calls on the record as of 2026-08-06.
