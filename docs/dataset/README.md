...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1402 so far, 805 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1402 calls on the record as of 2026-08-13.
