...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (778 so far, 192 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 778 calls on the record as of 2026-07-18.
