...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (682 so far, 142 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 682 calls on the record as of 2026-07-14.
