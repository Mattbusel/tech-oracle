...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (2074 so far, 1473 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 2074 calls on the record as of 2026-09-10.
