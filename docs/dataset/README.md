...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1834 so far, 1241 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1834 calls on the record as of 2026-08-31.
