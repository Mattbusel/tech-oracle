...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (322 so far, 48 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 322 calls on the record as of 2026-06-29.
