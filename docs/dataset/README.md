...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1858 so far, 1265 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1858 calls on the record as of 2026-09-01.
