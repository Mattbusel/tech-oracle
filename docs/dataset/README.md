...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1018 so far, 422 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1018 calls on the record as of 2026-07-28.
