...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1810 so far, 1219 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1810 calls on the record as of 2026-08-30.
