...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (898 so far, 316 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 898 calls on the record as of 2026-07-23.
