...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1642 so far, 1049 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1642 calls on the record as of 2026-08-23.
