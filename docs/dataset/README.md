...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1090 so far, 497 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1090 calls on the record as of 2026-07-31.
