...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (2002 so far, 1405 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 2002 calls on the record as of 2026-09-07.
