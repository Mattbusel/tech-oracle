...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (2050 so far, 1451 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 2050 calls on the record as of 2026-09-09.
