...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1618 so far, 1028 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1618 calls on the record as of 2026-08-22.
