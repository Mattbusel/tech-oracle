...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (1162 so far, 562 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 1162 calls on the record as of 2026-08-03.
