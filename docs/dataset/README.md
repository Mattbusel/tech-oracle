...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (850 so far, 268 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
...
## Updated
Daily. 850 calls on the record as of 2026-07-21.
