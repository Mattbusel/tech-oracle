...
## Files
- `predictions.csv` / `predictions.jsonl`: every public call (178 so far, 22 settled), with its market type, machine-checkable win condition, confidence, status and resolution date.
