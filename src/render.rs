...
(function(){
 ...
 var PACKS={
  std:{cost:250000,name:'STANDARD',series:'STREET',house:'THE STALL',vmul:1,odds:[['common',99.448],['rare',0.5],['legend',0.05],['ascended',0.002]],fin:[['',95],['shiny',4.4],['gold',0.5],['emerald',0.08],['sapphire',0.018],['diamond',0.004]]},
  prime:{cost:1000000,name:'PRIME',series:'PRIME',house:'THE VAULT',vmul:1.4,odds:[['common',98.296],['rare',1.5],['legend',0.2],['ascended',0.004]],fin:[['',91],['shiny',7],['gold',1.6],['emerald',0.3],['sapphire',0.07],['diamond',0.01]]},
  vault:{cost:50000000,name:'VAULT',series:'RESERVE',house:'THE RESERVE',vmul:2.2,odds:[['rare',98.49],['legend',1.5],['ascended',0.01]],fin:[['',78],['shiny',16],['gold',5],['emerald',0.8],['sapphire',0.16],['diamond',0.03]]},
  eclipse:{cost:1000000000,name:'ECLIPSE',series:'ECLIPSE',house:'ECLIPSE LINE',vmul:4,odds:[['legend',99.95],['ascended',0.05]],fin:[['',55],['shiny',28],['gold',13],['emerald',3],['sapphire',0.8],['diamond',0.2]]},
  cosmic:{cost:50000000000,name:'COSMIC',series:'COSMIC',house:'COSMIC SERIES',vmul:10,odds:[['legend',99.6],['ascended',0.4]],fin:[['',34],['shiny',33],['gold',23],['emerald',7],['sapphire',2.4],['diamond',0.6]]},
  singularity:{cost:1000000000000,name:'SINGULARITY',series:'SINGULARITY',house:'SINGULARITY',vmul:20,odds:[['legend',98],['ascended',2]],fin:[['',20],['shiny',31],['gold',30],['emerald',13],['sapphire',5],['diamond',1]]}
 };
