 ...
 function tick(){
  ...
  picks.forEach(function(b){
   ...
   ORGS.forEach(function(o){
    ...
    var frac=(0.03+o.risk*0.22)*(1+o.press*Math.min(Math.abs(o.streak),5)*0.12);
  ...
  ORGS.forEach(function(o){if(o.bank<1){o.bank=1000;o.w=0;o.l=0;o.streak=0;o.name=(o.name+"'").slice(0,22);}});
  rounds++;
