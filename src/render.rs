...
(function(){
 ...
 function save(){try{localStorage.setItem(KEY,JSON.stringify({orgs:ORGS,rounds:rounds,settled:settled,season:season,rafters:rafters,cards:cards,wallet:wallet,market:MARKET,day:window.__FLDAY}));}catch(e){}}
 ...
 seedBoard();drawBoards();drawMarket();
