...
(function(){
 ...
 Promise.all([
  ...
  cards.forEach(function(c){if(!c.code)c.code=newCode(c.id||0);if(c.risk==null)c.risk=0.4;});
 ...
 function claim(id){
  ...
  cards.unshift({code:newCode(id),id:id,name:o.name,house:o.house,fade:o.fade,risk:o.risk,sel:o.sel,press:o.press,claimedSeason:season,claimedRound:rounds});
